...
const CTA = () => {
    return (
        <div className="bg-blue-600 text-white rounded-lg p-6 max-w-md mx-auto shadow-md text-center">
          {/* Title */}
          <h1 className="text-2xl font-bold mb-2 px-10 ">Get Started with Bit Bazaar for FREE</h1>
          
          {/* Description */}
          <p className="text-sm mb-4">
            With our range of features that you can equip for free, Bit Bazaar allows you to be more educated and aware of your tax reports.
          </p>
